  ...
  try {
    ...
    if (user.role === 'operator') {
      if (! operatorId) {
        ...
        const operatorsSql = 'SELECT id, name FROM operators WHERE user_id = ?  AND is_active = TRUE';
      ...
      const operatorSql = 'SELECT * FROM operators WHERE id = ? AND user_id = ?  AND is_active = TRUE';
