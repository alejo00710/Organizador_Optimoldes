...
CREATE TABLE IF NOT EXISTS users (
  ...
  role TEXT NOT NULL CHECK (role IN ('admin', 'planner', 'operator', 'management')),
...
CREATE TABLE IF NOT EXISTS machines (
  ...
  hourly_price NUMERIC(12,2) NULL,
  notes TEXT NULL,
  is_active BOOLEAN NOT NULL DEFAULT TRUE,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS planning_history (
  ...
  status planning_status NOT NULL DEFAULT 'IN_PROGRESS',
...
CREATE INDEX IF NOT EXISTS idx_planning_history_mold_created ON planning_history (mold_id, created_at DESC);

CREATE TABLE IF NOT EXISTS plan_entries (
  id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  mold_id INTEGER NOT NULL REFERENCES molds(id) ON DELETE CASCADE,
  planning_id BIGINT NULL REFERENCES planning_history(id) ON DELETE SET NULL,
...
CREATE INDEX IF NOT EXISTS idx_plan_entries_planning_id ON plan_entries (planning_id);
...
CREATE TABLE IF NOT EXISTS work_logs (
  ...
  reason TEXT NULL,
  note TEXT NULL,
  is_final_log BOOLEAN NOT NULL DEFAULT false,
